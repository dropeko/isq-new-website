...
import ManifestoDepth from "@/components/manifesto/ManifestoDepth";
...
export default function Manifesto() {
  ...
  return (
    ...
    >
      ...
      {/* Profundidade em camadas — "descida ao detalhe" (parallax + cursor) */}
      <ManifestoDepth progress={scrollYProgress} />
